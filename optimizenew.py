...
class OptimizedBiddingBot:
    ...
    def is_valid_bid(self, player, current_bid):
        ...
        if len(self.players_acquired) >= self.MAX_PLAYERS:
            return False
    ...
    def estimate_value(self, player):
        ...
        Args:
            player: Player object containing stats.
...
def bidding_bot(player, purse_money_left, current_bid):
    ...
    """
    strategy = OptimizedBiddingBot(purse_money_left)
